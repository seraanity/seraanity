...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <button class="btn btn-primary" name="btn_artikel_baru" id="btn_artikel_baru" data-bs-toggle="modal" data-bs-target="#ModalKategori" >Kategori Baru</button>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            <td>
                                                <button class="btn btn-warning" name="btn_ubah_kategori" data-bs-toggle="modal" data-bs-target="#ModalUpdateKategori" <?php echo $data_id_kategori; ?>>Ubah</button>
                                                ...
                                                <div class="modal fade" data-bs-backdrop="static" id="ModalUpdateKategori"> <?php echo $data_id_kategori; ?>>
                                            ...
                                            <!-- Modal Header -->
                                                ...
                                                <form method="POST">
                                                    <div class="modal-body mb-3">
                                                        Apakah kategori dengan nama : <?php echo "<b>".$data_nama."</b>";?> akan di hapus?
        ...
        <div class="modal fade" data-bs-backdrop="static" id="ModalKategori">
        <div class="modal-dialog">
            <div class="modal-content">
